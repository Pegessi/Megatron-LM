...
export SNAP_FILE_NAME="pretrain_gpt_350M_mb8_pp4_mp2_b1_20iter"
...
### FlashDTR config
export DTR_ENABLE=0 # 启用动态张量重用功能
export MEM_BUDGET=3 # only budget > 0 can use RESIDUAL_DEGREE, otherwise reserve leak
